  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ButtonBar(alignment:MainAxisAlignment.spaceBetween,children: [
        ...
        ElevatedButton(onPressed: (){},style: ButtonStyle(shape:MaterialStatePropertyAll(StadiumBorder()),backgroundColor: MaterialStatePropertyAll(Colors.deepPurpleAccent)),
      ...
      body: SafeArea(child: Column(
                            ...
                            Expanded(child: VxArc(height: 30,edge: VxEdge.TOP,arcType: VxArcType.CONVEY,
                                    child: Container(color:creamColor,width: context.screenWidth,
                                            child: Column(
                                                    children: [
